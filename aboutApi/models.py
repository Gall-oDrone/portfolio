...
class Language(models.Model):
    ...
    level = models.CharField(max_length=100, choices=LANGUAGE_LEVELS, blank=True)
...
class PhoneModel(models.Model): 
    ...
    phone_type = models.CharField(verbose_name="Type", max_length=50, choices = PHONE_TYPES, blank=True)
...
class PersonalInfo(models.Model):
    ...
    phone = models.ManyToManyField(PhoneModel, related_name="personal_phone", blank=True, null=True)
...
class TechnologyUsed(models.Model):
    ...
    image = ResizedImageField(size=[66, 66], quality=75, upload_to='images/logos/technology/', null=True, blank=True)
...
class Employment(models.Model):
    ...
    resume = models.FileField(upload_to="files/resume", null=True, verbose_name="Resume")

class ProfileInfo(models.Model):
    personal = models.ForeignKey(PersonalInfo, related_name="personal_info", on_delete=models.CASCADE, blank=True, null=True)
    ...
    education = models.ForeignKey(Education, on_delete=models.CASCADE, related_name="user_education", blank=True, null=True)
    undergraduate = models.BooleanField(default=False)
    graduate = models.BooleanField(default=False)
    postgraduate = models.BooleanField(default=False)

    employment = models.ForeignKey(Employment, on_delete=models.CASCADE, related_name="user_employment", blank=True, null=True)
    ...
    contact_forms = models.ManyToManyField(ContactForm, related_name="user_contactform", blank=True, null=True)
    langauges = models.ManyToManyField(Language, related_name="user_language", blank=True, null=True)
